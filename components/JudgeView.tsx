      ...
      <div className="flex flex-col sm:flex-row sm:items-start gap-3 sm:gap-4">
        <div className="flex-grow min-w-0">
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-2">
            <h3 className="font-bold text-lg sm:text-xl text-ave-dark-blue dark:text-slate-100 pr-2">
              {candidate.nume}
            </h3>
            <div className="mt-2 sm:mt-0 flex items-center gap-2">
              ...
              <span className="hidden sm:block mt-0 text-sm text-gray-600 dark:text-slate-300">
                {category?.nume || 'Categorie necunoscută'}
              </span>
            </div>
          </div>
          <p className="text-base text-gray-600 dark:text-slate-400 mt-1">{candidate.scoala}</p>
          <p className="text-sm text-gray-500 dark:text-slate-500 mt-1">Regiune: {candidate.regiune}</p>
          <p className="text-sm text-gray-600 dark:text-slate-300 mt-1 sm:hidden">{category?.nume || 'Categorie necunoscută'}</p>
        </div>
      </div>
