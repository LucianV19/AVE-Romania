...
const CandidateSubmissionView: React.FC<CandidateSubmissionViewProps> = ({ candidate }) => {
    ...
    const Section = ({ title, children }: { title: string, children: React.ReactNode }) => (
        <div className="mb-8 border-b dark:border-slate-700 pb-6 last:border-0">
            <h3 className="text-lg font-bold text-ave-dark-blue dark:text-slate-100 mb-4">{title}</h3>
            {children}
        </div>
    );
    ...
    const Field = ({ label, value }: { label: string, value: string | number | undefined | null }) => (
        <div className="mb-3">
            ...
            <span className="block text-sm text-gray-900 dark:text-slate-200 mt-1">{value || '-'}</span>
        </div>
    );
    ...
    const LongField = ({ label, value }: { label: string, value: string | undefined | null }) => (
        <div className="mb-4">
            ...
            <div className="text-sm text-gray-900 dark:text-slate-200 whitespace-pre-wrap bg-gray-50 dark:bg-slate-700/30 p-3 rounded-lg border dark:border-slate-700">
                {value || '-'}
            </div>
        </div>
    );
    ...
    return (
        <div className="p-6 bg-white dark:bg-slate-800 rounded-lg shadow-sm">
            <Section title="A. Informații Generale">
            ...
            <Section title="B. Experiență Profesională">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <Section title="C. Unitate de Învățământ">
            ...
            <Section title="D. Statistici (2024-2025)">
            ...
            <Section title="E. Categorii de Participare">
                 <div className="flex flex-wrap gap-2">
            ...
            {formData.proiecteNarative && (
                <Section title="F. Proiecte Narative">
            ...
            <Section title="G. Prezență Online & Recomandări">
