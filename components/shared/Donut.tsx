      ...
      <div className="relative" style={{ width: size, height: size }}>
        <svg viewBox="0 0 36 36" className="w-full h-full" preserveAspectRatio="xMidYMid meet">
          <g transform="rotate(-90 18 18)">
            <circle cx="18" cy="18" r="16" fill="none" stroke="#e6e6e6" strokeWidth={strokeWidth} />
            <circle
              cx="18"
              cy="18"
              r="16"
        ...
        <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
          <div className="flex flex-col items-center justify-center bg-white dark:bg-slate-800 rounded-full shadow-sm w-12 h-12">
